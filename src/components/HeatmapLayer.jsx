...
const BORTLE_ANCHOR = [
  // Major cities
  [40.71, -74.01, 9], [40.66, -73.94, 9], [40.76, -73.89, 9],
  [42.36, -71.06, 8], [42.65, -73.75, 7], [43.05, -76.15, 7],
  [43.16, -77.61, 7], [42.89, -78.88, 8], [42.33, -83.05, 8],
  [45.42, -75.70, 7], [43.70, -79.42, 8], [45.50, -73.57, 8],
  [41.82, -71.42, 7], [41.31, -72.93, 7], [39.95, -75.17, 8],
  [41.76, -72.69, 7], [44.80, -68.78, 6], [43.66, -70.26, 7],
  [44.48, -73.21, 6], [43.21, -71.54, 6], [42.10, -75.91, 6],
  [41.50, -74.01, 7], [43.95, -75.92, 6], [44.70, -75.50, 6],
  [46.81, -71.22, 7], [45.27, -66.07, 6], [46.09, -64.78, 6],
  [44.65, -63.60, 7],
  // Suburban/rural transition
  [41.60, -73.00, 5], [42.50, -74.00, 5], [42.00, -74.50, 4],
  [42.20, -74.80, 3], [43.50, -74.50, 4], [44.50, -75.00, 4],
  [43.30, -72.50, 4], [44.00, -72.00, 4], [44.50, -71.50, 4],
  [45.00, -69.00, 3], [44.50, -70.00, 3], [45.50, -70.50, 2],
  [46.50, -69.00, 2], [47.00, -68.50, 2],
  // Adirondacks dark sky
  [44.20, -74.30, 2], [44.05, -73.95, 2], [43.97, -74.14, 2],
  [44.10, -74.52, 2], [44.29, -74.18, 2], [44.60, -74.00, 2],
  [44.80, -74.20, 2], [43.64, -73.50, 3], [43.80, -73.38, 3],
  [43.78, -74.26, 2], [43.50, -74.20, 3],
  // Quebec/Ontario wilderness
  [46.50, -77.00, 2], [47.00, -76.00, 2], [47.50, -75.00, 2],
  [48.00, -74.00, 2], [47.50, -72.00, 2], [47.00, -71.00, 2],
  [46.50, -70.00, 2], [47.00, -69.00, 2], [48.00, -78.00, 2],
  [46.00, -78.00, 2], [45.50, -77.00, 3], [45.00, -76.00, 3],
  // Maritime provinces
  [44.80, -63.10, 3], [46.00, -64.00, 3], [45.50, -65.00, 3],
  [45.00, -67.00, 3], [47.00, -66.00, 2], [46.50, -67.50, 2],
]
