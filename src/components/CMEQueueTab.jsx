              ...
              <div style={{ 
                ...
                {cme.aurora_rating && (
                  <span style={{ fontSize: 10, whiteSpace: 'nowrap', letterSpacing: 1 }}>
                    <span style={{ color: cme.aurora_rating.stars >= 4 ? '#ffaa00' : cme.aurora_rating.stars >= 2 ? '#ffcc66' : '#556677' }}>
                      {'★'.repeat(cme.aurora_rating.stars || 0)}
                    </span>
                    <span style={{ color: '#333d44' }}>
                      {'★'.repeat(5 - (cme.aurora_rating.stars || 0))}
                    </span>
